...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Malísimo, 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['Ok', 0.7], //69%
		['Bueno', 0.8], //From 70% to 79%
		['Bastante bien', 0.9], //From 80% to 89%
		['Muy Bien!', 1], //From 90% to 99%
		['PERFECTOOOO!!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
        ...
        var creditTxt:FlxText = new FlxText(4,healthBarBG.y + 20,0,("Tu Vieja Modpack"), 24);
		...
		botplayTxt = new FlxText(400, timeBarBG.y + 55, FlxG.width - 800, "¿Botplay? En serio?", 32);
